...
#### Status Checks
Checks whether services are running, reachable, and performing. These status checks are more on the application level, where the network is used to do these checks.
